...
$(function(){$("input.js-shift-key").click(function(a){if(a.shiftKey)$('[data-group="'+$(this).data("group")+'"]').prop("checked",$(this).prop("checked")||false)})});function convertToSlug(a){return a.toLowerCase().replace(/[^\w ]+/g,"").replace(/ +/g,"_").replace(/^[_]+/,"").replace(/[_]+$/,"")};
